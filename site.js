...
const cartinhasTextos = [
  ...
  { titulo: "Mês 5 - Aliançados e Apaixonados", mensagem: "Quando completamos 5 meses foi surreal como aquele mês foi incrível e como passou rápido, como as nossas alianças me fizeram ainda mais feliz e realizado, porque elas simbolizam muita coisa, o carinho, respeito, confiança, proximidade, intimidade, união e amor que temos um pelo outro.",  mensagem2: "Esse mês foi cheio de momentos especiais, mas o que mais marcou foi como começamos a nos perder legal. Os Dates trouxeram  tanta felicidade e amor, foram tão especiais para mim, foram momentos que vou guardar no coração para sempre."},

  { titulo: "Mês 6 - Longe, Mas Próximos", mensagem: "Esse mês, você ficou alguns dias na roça, e esses dias, só me fizeram perceber o quanto eu amo sua presença, senti muito a sua falta. Senti uma saudade gigante nesses dias, porque eu não tinha a sua companhia para tornar o meu dia melhor, mas quando a gente conseguiu se falar de novo, foi maravilhoso, tivemos callzinhas, e cada segundo valeu a espera.",  mensagem2: "A resenha com seus amigos foi legal, até curti fazer o slide no fim (apesar das reclamações), foi divertido, por mais que eu tenha sido um pouco chato."},

  { titulo: "Mês 7 - Mais Que Férias, Amor", mensagem: "Esse sétimo mês foi muito pika, porque a gente passou muito mais tempo juntinhos, curtindo as férias e aproveitando a companhia um do outro. Ter você no meu aniversário foi o melhor presente que eu poderia querer.",  mensagem2: "O presente incrível que você fez foi incrível e me mostrou, mais uma vez, o quanto você se importa comigo. Esses dias juntos foram especiais, poder passar várias horas com você, rir, conversar, aproveitar o tempo sem preocupações ... foi muito bom."},

  { titulo: "Mês 8 - Eu  Erreeeeiiiiii", mensagem: "Nesse oitavo mês, a gente acabou discutindo um pouco, mas conversamos, entendemos um ao outro e encontramos um jeito de resolver as coisas, o que eu adoro no nosso relacionamento, que nunca deixamos isso nos abalar e sempre e ficamos bem. ",  mensagem2: "Acabei sendo bem negligente com você meu amor, não te dando o cuidado e a atenção que você merece, me desculpa amor. Não foi um dos melhores meses, mas conseguimos supera-lo e continuamos crescendo juntos."},
  
  { titulo: "Mês 9 - Desculpas e Gratidão", mensagem: "Nesse nono mês, percebi o quanto já vivemos juntos — risadas, desafios e muito amor. Sei que em alguns momentos eu fiquei meio distante, preso nos meus pensamentos e não me abrindo com você, e acabei fazendo merda, e não demonstrei o carinho que você merece, me desculpa por ter te causado alguma insegurança, Mas saiba que te amo demais e nunca quis te deixar insegura.",  mensagem2: "Tenho que te agradecer também, porque seu cuidado comigo, tipo quando fiquei fodido de dor nas costas,  você tirou um tempo para me ajudar, foi um gesto tão fofo, que significou muito para mim. Só me faz ter mais certeza de que estar com você é a melhor coisa que me aconteceu."},

  { titulo: "Mês 10 - Novas Experiências e Amor", mensagem: "Esse décimo mês foi diferente de todos os outros. Toda vez que a gente se encontrou, fizemos algo novo e fora da rotina — fritamos batata, fizemos ovos de Páscoa, preparamos hambúrguer… E, qualquer coisa com você se torna incrível. Foi pika viver essas experiências simples, mas cheias de significado, do seu lado.",  mensagem2: "Foi mal ter escondido aquele problema de você por tanto tempo. Eu devia ter confiado mais em nós dois e te contado antes. Mas fico muito feliz que, mesmo com isso, a gente conseguiu conversar e resolver tudo de uma forma simples, mostrando que o problema não era tão grande quanto eu imaginava."},
